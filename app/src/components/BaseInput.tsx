  ...
  return (
    <div className="relative h-11 w-full min-w-[200px]">
      ...
      <input
        ...
        name={name}
        {...register(name)}
        className={`h-full w-full disabled:text-muted border-b border-metal bg-transparent placeholder:text-muted pt-4 pb-1.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50`}
      />
