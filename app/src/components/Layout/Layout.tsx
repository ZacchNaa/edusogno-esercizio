...
const Layout: FC<LayoutProps> = ({ children }) => {
  return (
    <div className="relative w-full bg-lightblue md:bg-hero-wave bg-cover h-screen lg:h-[160vh]">
      ...
      <div className="absolute bg-white w-0 h-0 md:w-20 md:h-20 xl:w-40 xl:h-40 2xl:w-32 2xl:h-32 rounded-full bottom-0 md:bottom-80 xl:bottom-[30%] 2xl:bottom-1/2 right-5 2xl:right-10"></div>
      {/* Content */}
